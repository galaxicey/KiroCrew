...
vi.mock('../../hooks/usePanelTabs', async () => ({
  ...
  purgeDocumentBodiesForRedactionChange: vi.fn((qc: { removeQueries: (f: { queryKey: unknown[] }) => unknown }) => { qc.removeQueries({ queryKey: ['file-read'] }); qc.removeQueries({ queryKey: ['file-diff'] }) }),
}))
