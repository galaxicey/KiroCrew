...
describe('the folder order behind the picker', () => {
  ...
  it('says when that order could not be read, and keeps the picker usable', async () => {
    ...
    expect(notice.parentElement).toHaveTextContent('Folders are listed in your saved order; retries automatically. Open the chat sidebar to ask the agent about it.')
