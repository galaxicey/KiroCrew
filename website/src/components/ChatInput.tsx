...
function ChatInput({
   ...
   *
   *  Declared above both callers — `handleKeyDown`'s Alt+Enter route and
   *  `handleTextareaClick`'s pointer routes — because a `useCallback`
   *  dependency list is read during render, so a later `const` would be in its
