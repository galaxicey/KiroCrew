        ...
        >
          {([
            ...
            <button
              key={t.key}
              type="button"
              className="w-[240px] max-w-full min-w-0 p-3 rounded-xl border border-border bg-card hover:border-accent transition-colors text-left grid grid-cols-[30px_1fr] gap-x-2.5 gap-y-1 items-start cursor-pointer"
