        ...
        *privacy_request* is a modifier the caller stripped off *text*, and the two
        ...
        if mode != "queue" and not msg.attachments:
            ...
            if privacy_request and can_steer:
                ...
                # hands back what a failed steer must release.
                try:
            ...
            try:
                ...
                # The steer raised: the message is not in the turn. Take the
                # reservation back, then let the failure propagate as before.
            ...
            if steered:
                if reservation is not None:
                    privacy_mode.commit(reservation)
